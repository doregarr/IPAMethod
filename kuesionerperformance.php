...
$queryPertanyaan = "SELECT * FROM tbl_pertanyaan WHERE kategori = 'Performance' ORDER BY jenis_pertanyaan";
$resultPertanyaan = mysqli_query($koneksi, $queryPertanyaan);
?>

<main id="main" class="main">
    <div class="pagetitle">
        <h1>Kuesioner Peformance</h1>
    </div>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="tambahjawabanperformance.php" method="POST">
                            <div class="row mb-3">
